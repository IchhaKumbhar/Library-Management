...
<body class="bg-gradient-primary">
    <!-- <section class="header">
        ...
        <a href="home.html" class="logo">Library Management System</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="admin-login-ser.php" method="get">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.php" style="visibility: hidden;">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
